...
TEST_F(TestFingerprint, TestConstructor) {
    ...
    eqc_x->add(ArgIndicator::variableIndicator(1, 0));
    eqc_x->add(ArgIndicator::variableIndicator(2, 0));
    eqc_x->add(ArgIndicator::variableIndicator(1, 0));
    Fingerprint::equivalenceClassType* eqc_c = new Fingerprint::equivalenceClassType();
    eqc_c->add(ArgIndicator::variableIndicator(1, 1));
    eqc_c->add(ArgIndicator::constantIndicator(3));
    Fingerprint::equivalenceClassType* eqc_y = new Fingerprint::equivalenceClassType();
    eqc_y->add(ArgIndicator::variableIndicator(2, 1));
    eqc_y->add(ArgIndicator::variableIndicator(3, 0));
    Fingerprint::equivalenceClassType* eqc_z = new Fingerprint::equivalenceClassType();
    eqc_z->add(ArgIndicator::variableIndicator(3, 1));
    eqc_z->add(ArgIndicator::variableIndicator(1, 0));
    Fingerprint::equivalenceClassType* eqc_e = new Fingerprint::equivalenceClassType();
    eqc_e->add(ArgIndicator::variableIndicator(3, 2));
    eqc_e->add(ArgIndicator::constantIndicator(5));
    Fingerprint::equivalenceClassType* eqc_uv1 = new Fingerprint::equivalenceClassType();
    eqc_uv1->add(ArgIndicator::variableIndicator(1, 1));
    Fingerprint::equivalenceClassType* eqc_uv2 = new Fingerprint::equivalenceClassType();
    eqc_uv2->add(ArgIndicator::variableIndicator(1, 1));
